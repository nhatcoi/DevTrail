        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Giới thiệu <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">DevTrail</span> 🚀
            </h1>
            <h2 className="text-xl md:text-2xl font-medium text-gray-700 dark:text-gray-300 mb-8">
              Tạo ra portfolio của bạn
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-10">
              Trưng bày công việc của bạn một cách đẹp mắt ❤️
            </p>
            ...
            <p className="mt-6 text-sm text-gray-500 dark:text-gray-400">
              Được tin tưởng bởi hơn 1.000 người dùng ✨
            </p>
          </motion.div>
